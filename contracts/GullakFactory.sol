...
import {IGullakERC20} from "./IGullakERC20.sol";
 ...
 */
contract GullakFactory is GullakSpawner, Ownable {
  ...
  function createHodlERC20(
    ...
    bytes memory initializationCalldata = abi.encodeWithSelector(
      IGullakERC20(implementation).init.selector,
      _token,
      _penalty,
      _lockWindow,
      _expiry,
  ...
  function getTargetHTokenAddress(
    ...
    bytes memory initializationCalldata = abi.encodeWithSelector(
      IGullakERC20(_implementation).init.selector,
      _token,
      _penalty,
      _lockWindow,
      _expiry,
